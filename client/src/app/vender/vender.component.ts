...
@Component({
  ...
  styleUrls: ['./vender.component.scss','./vender.component.css'],
  providers:[ AuthService, apiPerfilService, VendedoresService]
})
export class VenderComponent implements OnInit, DoCheck  {
...
ngDoCheck(){this.mismarcas=this.selectedValues;}
